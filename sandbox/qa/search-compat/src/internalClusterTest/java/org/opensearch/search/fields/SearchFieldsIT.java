...
public class SearchFieldsIT extends ParameterizedStaticSettingsOpenSearchIntegTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        ...
        _mustangPlugins.addAll(Arrays.asList(InternalSettingsPlugin.class, CustomScriptPlugin.class)); return _mustangPlugins;
    }
    ...
    public void testSingleValueFieldDatatField() throws ExecutionException, InterruptedException {
        ...
        indexRandom(true, false, client().prepareIndex("test").setId("1").setSource("test_field", "foobar"));
        refresh();
