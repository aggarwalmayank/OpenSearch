...
public class MedianAbsoluteDeviationIT extends org.opensearch.sandbox.search.MustangAbstractNumericTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        return java.util.Arrays.asList(AggregationTestScriptsPlugin.class,
