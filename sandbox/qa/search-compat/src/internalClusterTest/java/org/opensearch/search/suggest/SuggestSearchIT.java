...
public class SuggestSearchIT extends ParameterizedStaticSettingsOpenSearchIntegTestCase {
    ...
    public void testDifferentShardSize() throws Exception {
        ...
        ensureGreen();
        indexRandom(true, false,
            client().prepareIndex("test").setSource("field1", "foobar1").setRouting("1"),
            client().prepareIndex("test").setSource("field1", "foobar2").setRouting("2"),
            client().prepareIndex("test").setSource("field1", "foobar3").setRouting("3")
        );
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        ...
        _mustangPlugins.addAll(Collections.singleton(DummyTemplatePlugin.class)); return _mustangPlugins;
    }
