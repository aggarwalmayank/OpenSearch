...
public class IpTermsIT extends AbstractTermsTestCase {
    ...
    public void testScriptValue() throws Exception {
        ...
        indexRandom(true, false,
            client().prepareIndex("index").setSource("ip", "192.168.1.7"),
            client().prepareIndex("index").setSource("ip", "192.168.1.7"),
            client().prepareIndex("index").setSource("ip", "2001:db8::2:1")
        );
    ...
    public void testMissingValue() throws Exception {
        ...
        indexRandom(true, false,
            client().prepareIndex("index").setSource("ip", "192.168.1.7"),
            client().prepareIndex("index").setSource("ip", "192.168.1.7"),
            client().prepareIndex("index").setSource("ip", "127.0.0.1"),
            client().prepareIndex("index").setSource("not_ip", "something")
        );
        SearchResponse response = client().prepareSearch("index")
