...
public class SearchQueryIT extends ParameterizedStaticSettingsOpenSearchIntegTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        ...
        _mustangPlugins.addAll(Arrays.asList(InternalSettingsPlugin.class, MockAnalysisPlugin.class)); return _mustangPlugins;
    }
    ...
    public void testTermIndexQuery() throws Exception {
        ...
        for (String indexName : indexNames) {
            ...
            indexRandom(true, false, client().prepareIndex(indexName).setId(indexName + "1").setSource("field1", "value1"));
