...
public class HighlighterSearchIT extends ParameterizedStaticSettingsOpenSearchIntegTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        ...
        _mustangPlugins.addAll(Arrays.asList(InternalSettingsPlugin.class, MockKeywordPlugin.class, MockAnalysisPlugin.class)); return _mustangPlugins;
    }
    ...
    public void testHighlightIssue1994() throws Exception {
        ...
        indexRandom(false, false, client().prepareIndex("test").setId("1").setSource("title", titles, "titleTV", titles));
    ...
    public void testHighlighterWithWordBoundaryScanner() throws Exception {
        ...
        indexRandom(true, false, client().prepareIndex("test").setSource("field1", "some quick and hairy brown:fox jumped over the lazy dog"));
    ...
    public void testDoesNotHighlightTypeName() throws Exception {
        ...
        indexRandom(true, false, client().prepareIndex("test").setSource("foo", "test typename"));
    ...
    public void testDoesNotHighlightAliasFilters() throws Exception {
        ...
        indexRandom(true, false, client().prepareIndex("test").setSource("foo", "test japanese"));
