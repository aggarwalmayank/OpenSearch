...
public class LongTermsIT extends AbstractTermsTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        return java.util.Arrays.asList(CustomScriptPlugin.class,
    ...
    public void setupSuiteScopeCluster() throws Exception {
        ...
        indexRandom(true, false, lowCardBuilders);
        ...
        indexRandom(true, false, highCardBuilders);
        ...
        indexRandom(true, false, builders.toArray(new IndexRequestBuilder[0]));
        ensureSearchable();
    }
