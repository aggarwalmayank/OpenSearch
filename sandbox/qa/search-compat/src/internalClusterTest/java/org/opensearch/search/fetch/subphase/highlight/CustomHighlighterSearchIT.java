...
public class CustomHighlighterSearchIT extends ParameterizedStaticSettingsOpenSearchIntegTestCase {
    ...
    protected void setup() throws Exception {
        indexRandom(true, false,
            client().prepareIndex("test").setSource("name", "arbitrary content", "other_name", "foo", "other_other_name", "bar"),
            client().prepareIndex("test").setSource("other_name", "foo", "other_other_name", "bar")
        );
    }
