...
public class CrossClusterSearchIT extends AbstractMultiClustersTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins(String clusterAlias) {
        ...
        plugins.add(org.opensearch.arrow.allocator.ArrowBasePlugin.class);
        plugins.add(org.opensearch.arrow.flight.transport.FlightStreamPlugin.class);
        plugins.add(org.opensearch.analytics.AnalyticsPlugin.class);
        plugins.add(org.opensearch.be.datafusion.DataFusionPlugin.class);
        plugins.add(org.opensearch.be.lucene.LucenePlugin.class);
        plugins.add(org.opensearch.composite.CompositeDataFormatPlugin.class);
        plugins.add(org.opensearch.parquet.ParquetDataFormatPlugin.class);
        plugins.add(org.opensearch.dsl.DslQueryExecutorPlugin.class);
        return plugins;
    }
