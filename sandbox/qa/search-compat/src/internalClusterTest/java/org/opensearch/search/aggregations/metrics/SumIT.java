...
public class SumIT extends org.opensearch.sandbox.search.MustangAbstractNumericTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        return java.util.Arrays.asList(MetricAggScriptPlugin.class,
    ...
    /** This test has been moved to SumAggregatorTests#testUnmapped() */
    @Override
