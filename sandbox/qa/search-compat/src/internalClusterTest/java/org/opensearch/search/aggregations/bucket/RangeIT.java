...
public class RangeIT extends ParameterizedStaticSettingsOpenSearchIntegTestCase {
    ...
    public void testScriptCaching() throws Exception {
        ...
        indexRandom(true, false,
            client().prepareIndex("cache_test_idx").setSource(jsonBuilder().startObject().field("i", 1).endObject()),
            client().prepareIndex("cache_test_idx").setSource(jsonBuilder().startObject().field("i", 2).endObject())
        );
