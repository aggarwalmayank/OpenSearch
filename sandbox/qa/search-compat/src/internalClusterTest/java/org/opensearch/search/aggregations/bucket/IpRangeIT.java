...
public class IpRangeIT extends ParameterizedStaticSettingsOpenSearchIntegTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        ...
        _mustangPlugins.addAll(Arrays.asList(DummyScriptPlugin.class)); return _mustangPlugins;
    }
    ...
    public void setupSuiteScopeCluster() throws Exception {
        ...
        indexRandom(true, false,
            client().prepareIndex("idx").setSource("ip", "192.168.1.7", "ips", Arrays.asList("192.168.0.13", "192.168.1.2")),
            client().prepareIndex("idx").setSource("ip", "192.168.1.10", "ips", Arrays.asList("192.168.1.25", "192.168.1.28")),
