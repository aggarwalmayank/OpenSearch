...
public class GeoShapeIntegrationIT extends ParameterizedStaticSettingsOpenSearchIntegTestCase {
    ...
    public void testIgnoreMalformed() throws Exception {
        ...
        indexRandom(true, false, client().prepareIndex("test").setSource("shape", polygonGeoJson));
    ...
    public void testIndexShapeRouting() throws Exception {
        ...
        indexRandom(true, false, client().prepareIndex("test").setSource(source, MediaTypeRegistry.JSON).setRouting("ABC"));
    ...
    public void testIndexPolygonDateLine() throws Exception {
        ...
        indexRandom(true, false, client().prepareIndex("quad").setSource(source, MediaTypeRegistry.JSON));
        indexRandom(true, false, client().prepareIndex("vector").setSource(source, MediaTypeRegistry.JSON));
