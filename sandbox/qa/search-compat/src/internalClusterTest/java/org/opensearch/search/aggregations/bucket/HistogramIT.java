...
public class HistogramIT extends ParameterizedStaticSettingsOpenSearchIntegTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        ...
        _mustangPlugins.addAll(Collections.singleton(CustomScriptPlugin.class)); return _mustangPlugins;
    }
    ...
    public void testDecimalIntervalAndOffset() throws Exception {
        ...
        indexRandom(true, false,
            client().prepareIndex("decimal_values").setSource("d", -0.6),
            client().prepareIndex("decimal_values").setSource("d", 0.1)
        );
    ...
    public void testScriptCaching() throws Exception {
        ...
        indexRandom(true, false,
            client().prepareIndex("cache_test_idx").setSource("d", -0.6),
            client().prepareIndex("cache_test_idx").setSource("d", 0.1)
        );
    ...
    public void testHardBounds() throws Exception {
        ...
        indexRandom(true, false,
            client().prepareIndex("test").setSource("d", -0.6),
            client().prepareIndex("test").setSource("d", 0.5),
            client().prepareIndex("test").setSource("d", 0.1)
        );
